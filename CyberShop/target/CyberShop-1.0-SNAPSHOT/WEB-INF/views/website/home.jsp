                    ...
                    <div class="col-sm-7" id="test">
                        <div class="btn-group" >
                            ...
                            <div class="dropdown-menu">
                                ...
                                <br/>
                                <a class="dropdown-item" href="#">Phụ kiên</a>
                                <br/>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        <div class="v3-new-arrival-title">Khuyến mại hot - Giá sốc tận óc</div>
                        <div class="product-carousel">
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img class="p1" src="img/threadripper_2970wx_gearvn.jpg" alt="">
                                ...
                                <h2><a href="single-product.html">SAMD Threadripper™ 2970WX Socket TR4</a></h2>

                                <div class="product-carousel-price">
                                    <ins>32,300,000₫</ins> <del>34,300,000₫</del>
                                </div> 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                ...
                                <h2>ASROCK Z390 Phantom Gaming 6 LGA1151V2</h2>
                                <div class="product-carousel-price">
                                    <ins>4,870,000₫</ins> <del>5,370,000₫</del>
                                </div> 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                ...
                                <h2>Corsair HS50 Stereo Gaming Blue</h2>

                                <div class="product-carousel-price">
                                    <ins>1,390,000₫</ins> <del>1,590,000₫</del>
                                </div>                                 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                ...
                                <h2><a href="single-product.html">SteelSeries Arctis 5 PUBG Edition</a></h2>

                                <div class="product-carousel-price">
                                    <ins>3,190,000₫</ins> <del>3,290,000₫</del>
                                </div>                            
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                ...
                                <h2>(16GB DDR4 2x8G 3200) HyperX Predator RGB</h2>

                                <div class="product-carousel-price">
                                    <ins>4,300,000₫</ins> <del>4,700,000₫</del>
                                </div>                                 
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        <div class="title">
                            <div class="v3-new-arrival-title2">Hàng mới về - Đừng bỏ lỡ</div>
                            <div>
                                <div class="product-carousel">
                                    <div class="single-product">
                                        <div class="product-f-image">
                                            <img class="p1" src="img/b8.jpg" alt="">
                                            <div class="product-hover">
                                                <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i>Thêm vào giỏ</a>
                                                <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i>Xem chi tiết</a>
                                            </div>
                                    ...
                                    <div class="single-product">
                                        ...
                                        <h2>Intel Core i9 9900k /8 nhân 16 luồng</h2>
                                        <div class="product-carousel-price">
                                            <ins>17,000,000₫</ins>
                                        </div> 
                                    </div>
                                    <div class="single-product">
                                        ...
                                        <h2>Case NZXT H500i (Mid - Tower)</h2>
                                    ...
                                    <div class="single-product">
                                        ...
                                        <h2><a href="single-product.html">Tản nhiệt nước AIO NZXT Kraken X62</a></h2>
                                    ...
                                    <div class="single-product">
                                        ...
                                        <h2>Asus ROG Centurion True 7.1</h2>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-menu">
                    ...
                    <ul>
                        ...
                        <li><a href="#">PhiếuThêm vào giỏ bảo hành</a></li>
